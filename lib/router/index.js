...
module.exports = function (opts = {}) {
  ...
  routes.signout = function (opts = {}, cb, next) {
    ...
    let o = id ? service.clearTokenById(id) : service.signout(opts.token)
    o.then(doc => {
        cb(null, doc)
      })
      .catch(e => {
  ...
  routes.touch = function (opts = {}, cb, next) {
    service.touch(opts.token, opts.data)
      .then(doc => {
        cb(null, doc)
      })
      .catch(e => {
  ...
  let filterToken = function (opts, cb, next) {
    opts.data && opts.data.token && (opts.token = opts.data.token)
    opts.headers && opts.headers.authorization && (opts.token = opts.headers.authorization)
    next()
  }
